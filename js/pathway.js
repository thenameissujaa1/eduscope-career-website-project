                                ...
                                switch(maxQual){
                                    ...
                                    case 'AS Level/S5':
                                        html = renderOption_3('You could do...',
                                            'Foundation Year','Bachelors','A levels/S6',
                                            'primary','warning','primary',
                                            'Some choose to do a foundation year instead of A levels','Not many universities support this','A levels/S6 is recommended by most universities',
                                            'foundation_year','bachelors','s6',
                                            's5');
                                    break;
                                    case 'A Level/S6':
                                        html = renderOption_1('You should do...',
                                            'Bachelors',
                                            'primary',
                                            'You will start your Bachelors',
                                            'bachelors',
                                            'foundation_year');
                                    break;
                                    case 'Bachelors':
...
function renderOption_3(title,a,b,c,type_a,type_b,type_c,help_a,help_b,help_c,data_to_a,data_to_b,data_to_c,data_from){
    ...
    html += '<div class="col-xs-12 panel panel-default">';
    html += '<div class="panel-heading">'+title+'</div>';
    html += '<div class="panel-body"><div class="row"><div class="col-xs-4">';
    html += '<button class="btn btn-lg btn-'+type_a+'" id="future_select" data-from="'+data_from+'" data-to="'+data_to_a+'">'+a+'</button>';
    html += '<p>'+help_a+'</p>';
