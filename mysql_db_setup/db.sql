...
--
-- Host: localhost
-- Generation Time: Mar 30, 2016 at 03:12 PM
...
(17, 2, 'School', 2002, 'GCSE or similar'),
(23, 2, 'School', 2001, 'AS levels or similar'),
(24, 2, 'School', 2005, 'A levels or similar');
...
INSERT INTO `user_subject_score` (`fk_user_id`, `fk_subject_id`, `score`, `interest`) VALUES
(2, 1, 150, 0),
(2, 2, 150, 0);
...
--
ALTER TABLE `userdetail`
  MODIFY `userDetail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `institute_qualification`
  ADD CONSTRAINT `FK_myKey11` FOREIGN KEY (`fk_institute_id`) REFERENCES `universities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
